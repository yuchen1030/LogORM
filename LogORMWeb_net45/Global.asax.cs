...
namespace LogORMWeb_net45
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            //第一步：注册日志系统
           // LogApi.RegisterLogInitMsg(SysCategory.SysD_06, Application, GetUserConfigItemByCode(), GetLogWebApplicationsNameByCode());//日志系统注册
                                                                                          
            LogApi.RegisterLogInitMsg(SysCategory.SysD_06);//日志系统注册
        }
