...
namespace LogORM.ComUtil
{
    ...
    internal class LambdaToSqlHelper<T>
    {
        ...
        /// <returns></returns>
        public static string GetWhereFromLambda(Expression<Func<T, bool>> predicate, DBStoreType databaseType)
        {
        ...
        /// <returns></returns>
        static bool GetWithQuotationMarks(DBStoreType databaseType)
        {
            bool result = false;
            switch (databaseType)
            {

                case DBStoreType.PostgreSQL:
    ...
    internal class ExpressBool
    {
        ...
        internal class ConditionBuilder : ExpressionVisitor
        {
            ...
            /// 数据库类型
            /// </summary>
            private DBStoreType m_dataBaseType = DBStoreType.NoSelect;
            /// <summary>
            /// 字段是否加引号
            /// </summary>
            ...
            #region 设置是数据库类型
            public void SetDataBaseType(DBStoreType databaseType)
            {
                if (databaseType != DBStoreType.NoSelect)
                {
            ...
            /// <param name="databaseType"></param>
            /// <returns></returns>
            public static string GetLikeConnectorWords(DBStoreType databaseType)
            {
                string result = "+";
                switch (databaseType)
                {
